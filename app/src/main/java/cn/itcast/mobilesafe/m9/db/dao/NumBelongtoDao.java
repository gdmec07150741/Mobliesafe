package cn.itcast.mobilesafe.m9.db.dao;
...
public class NumBelongtoDao {
    ...
    public static String getLocation(String phonenumber){
        ...
        SQLiteDatabase db = SQLiteDatabase.openDatabase("/data/data/cn.itcast.tyxing/files/address.db",null,SQLiteDatabase.OPEN_READONLY);
