...
import cn.itcast.mobilesafe.m9.utils.SmsBackUpUtils;
import cn.itcast.mobilesafe.m9.utils.UIUtils;
import cn.itcast.mobilesafe.m9.widget.MyCircleProgress;
                 ...
                 new Thread(){
                   public void run(){
                       try{
                           ...
                           e.printStackTrace();
                           UIUtils.showToast(SMSBackupActivity.this,"生成失败");
                       }catch (IllegalStateException e){
                           e.printStackTrace();
                           UIUtils.showToast(SMSBackupActivity.this,"SD卡不可用或者SD卡内存不足");
                       }catch (IOException e){
                           e.printStackTrace();
