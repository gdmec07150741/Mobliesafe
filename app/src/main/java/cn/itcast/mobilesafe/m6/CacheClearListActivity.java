package cn.itcast.mobilesafe.m6;
...
import cn.itcast.mobilesafe.m6.adapter.CacheCleanAdapter;
import cn.itcast.mobilesafe.m6.entity.CacheInfo;
    ...
    public void getCacheSize(PackageInfo info){
        try{
            Method method=PackageManager.class.getDeclaredMethod(
                    "getPackgeSizeInfo",String.class,
