package cn.itcast.mobilesafe.m8;
...
import cn.itcast.mobilesafe.m8.db.dao.TrafficDao;
...
public class TrafficMonitoringActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!SystemInfoUtils.isServiceRunning(this,"com.example.min123." +
